		...
		<div class="container-fluid">
					<h2 class="page-title">前台用户</h2>
						<ul class="breadcrumb">
							...
							<li><a href="<%=basePath %>user/add_user.jsp">前台用户添加</a></li>
						</ul>
					<div class="tabbable tabbable-custom tabbable-full-width">
						<ul class="nav nav-tabs">
							<li role="presentation"><a href="<%=basePath %>user/userShowAction_show.action">前台用户信息</a>
							</li>
							<li role="presentation" class="active"><a href="#">前台用户添加</a>
							</li>
						</ul><br><br>
						
						<form class="form-horizontal" action="<%=basePath %>user/userAction_addUser"
					method="post" enctype="multipart/form-data">
						<div class="col-xs-7 col-xs-offset-2">
							<div class="control-group" id="gro-username">
								<label for="username" class="control-label">用&nbsp;户&nbsp;名：</label>
								<div class="controls">
									<input type="text" class="span6 m-wrap" name="username" value=""
										placeholder="输入用户名">
								</div>
								<div class="controls" >
							...
							<div class="control-group">
								<div class="controls">
									<button type="button"
										class="btn red button-next" id="btn-add" onclick="checkAdd(this.form)">提交添加 
