    	...
    	<div class="container-fluid">
			 ...
			 <div class="tabbable tabbable-custom tabbable-full-width">
			   <ul class="nav nav-tabs">
				  <li role="presentation" class="active"><a href="#" >菜品信息</a></li>
				  <li role="presentation"><a href="<%=basePath %>goods/food_add.jsp">菜品添加</a></li>
				</ul>
	          <div class="table-responsive">
	            <table class="table table-striped table-hover" id="food_show">
	              <thead>
	                <tr>
	                  <th>菜品ID</th>
	                  <th style="padding-left:80px;">图片</th>
	                  <th class="hidden-phone" style="padding-left:20px">菜品</th>
	                  <th style="width:100px;padding-left:3px;">价格</th>
	                  <th style="padding-left:20px;">描述</th>
	                  <th style="width:150px;padding-left:40px;">菜系</th>
	                  <th style="padding-left:20px;">操作</th>
	                </tr>
	              </thead>
	              <tbody>
	              	<!-- 迭代 -->
					<s:iterator value="foods" status="st" var="food">
	                <tr id="btn-<s:property value="id"/>">
	                 <td style="width:55px;height:113px;"><s:property value="#food.id"/></td>
					 <td style="width:250px;height:113px;">
					 	<div align="center" style="width:175px;height:116px;">
							<img style="width: 117px; height: 88px;margin-top:10px;" src="<%=basePath %>image/foodImg/<s:property value="#food.img" />" alt="..." class="img-rounded" >
						</div>
					 </td>
					 <td><s:property value="#food.foodName"/></td>
					 <td style="width:20px;"><s:property value="#food.price"/></td>
					 <td style="width:150px;padding-left:-220px;"><s:property value="#food.description"/></td>
					 <td style="padding-left:40px;"><s:property value="#food.foodStyle.styleName"/></td>
	                  <td><a onclick="deleteFood(<s:property value="id"/>)"><i class="icon-trash"></i></a> | 
	                      <a href="<%=basePath %>goods/foodAction_queryFood.action?id=<s:property value="id"/>"><i class="icon-edit"></i></a></td>
	                </tr>
	              </s:iterator>
                 </tbody>
               </table>
                	...
                	<div class="pagination">
							<ul>
							 ...
							 <div class="pagination-goto">
								 <form id ="search" action="<%=basePath %>goods/foodShowAction_show.action" method="post">
