		...
		<div class="container-fluid">
					...
					<div class="tabbable tabbable-custom tabbable-full-width">
						<ul class="nav nav-tabs">
							...
							<li role="presentation" class="active"><a href="#">菜系添加</a>
							</li>
						</ul><br><br>
						
						<form class="form-horizontal" action="<%=basePath %>goods/foodStyleAction_addFoodStyle"
					method="post" enctype="multipart/form-data">
						<div class="col-xs-7 col-xs-offset-2">
							<div class="control-group" id="gro-foodStyleId">
								<label for="foodStyleId" class="col-xs-2 control-label">菜&nbsp;系&nbsp;号：</label>
								<div class="controls">
									<input type="text" class="span6 m-wrap" name="foodStyleId" value=""
										placeholder="输入菜系号">
								</div>
								<div class="controls">
							...
							<div class="control-group" id="gro-styleName">
								<label for="styleName" class="control-label">菜&nbsp;系&nbsp;名：</label>
								<div class="controls">
									<input type="text" class="span6 m-wrap" name="styleName" value=""
										placeholder="输入菜系名">
								</div>
								<div class="controls" >
