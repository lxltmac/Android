    	...
    	<div class="container-fluid">
			 <h2 class="page-title">订单</h2>
			 	<ul class="breadcrumb">
					...
					<li><a href="<%=basePath %>order/orderShowAction_show.action">订单信息</a></li>
				</ul>
			 <div class="tabbable tabbable-custom tabbable-full-width">
			   <ul class="nav nav-tabs">
				  <li role="presentation" class="active"><a>订单信息</a></li>
				  <li role="presentation"><a href="<%=basePath %>order/orderChuiShowAction_show.action">催单处理</a></li>
				</ul>
	          <div class="table-responsive">
	            <table class="table table-striped table-hover" id="user_show">
	              ...
	              <tbody>
	              	<!-- 迭代 -->
					<s:iterator value="orders" status="st" var="orderList">
	                <tr id="btn-<s:property value="id"/>">
	                 <td><s:property value="#orderList.id"/></td>
	                 <td><s:property value="#orderList.tableNum"/></td>
	                  <td> 
	                      <a style="margin-left:18px;" href="<%=basePath %>order/orderListShowAction_show.action?tableNum=<s:property value="tableNum"/>" style="cursor:pointer;"><i class="icon-list-alt"></i></a></td>
	                </tr>
	              </s:iterator>
                 </tbody>
               </table>
                	...
                	<div class="pagination">
							<ul>
							 ...
							 <div class="pagination-goto">
								 <form id ="search" action="<%=basePath %>order/orderShowAction_show.action" method="post">
