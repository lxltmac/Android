...
var App = function () {
    ...
    var handleDesktopTabletContents = function () {
        // 循环页面元素为"responsive" 的class和试用于平板模式的class
        // 为页面高于1280px 或者至少作为平板模式去正确显示内容
        ...
        // 循环页面元素为"responsive" 的class和试用于桌面模式的class
        // 为页面高于1280px 或者至少设置为桌面模式正确显示内容
...
//当窗口的宽度小于980时去掉body中的page-sidebar-closed选项
    ...
    var handleFixedSidebar = function () {
        ...
        if (menu.parent('.slimScrollDiv').size() === 1) { // 更新当前高度时去掉现有高度
            menu.slimScroll({
                destroy: true
            });
    ...
    return {
        ...
        blockUI: function (el) {
            var el = $(el); 
            el.block({
                    message: '<img src="./image/loading.gif" align="">',
