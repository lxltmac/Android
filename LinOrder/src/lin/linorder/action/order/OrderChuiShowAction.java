...
public class OrderChuiShowAction extends ActionSupport implements ServletRequestAware {
	...
	public List<OrderChui> getOrders() {
		return orders;
	}
	...
	public void setOrders(List<OrderChui> orders) {
		this.orders = orders;
	}
	...
	public String show() throws Exception{
        ...
        orders=orderService.queryOrderChuiByNum(tableNum);
		//计算总页数
		...
		//根据当前页查询要在该页上显示的数据
		orders=orderService.queryByPageChui(pageNo,pageSize);
